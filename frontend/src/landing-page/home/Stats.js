...
function Stats() {
  return (
    <div className='container pt-3 mt-3 p-3'>
      <div className='row p-5'>
        <div className='col-6 pt-5 ps-5'>
          <h1 className='fs-2'>Trust with confidence</h1><br/><br/>
          <h2 className="fs-4">Customer-first always</h2>
          <p className="text-muted">That's why 1.3+ crore customers trust Zerodha with ₹3.5+ lakh crores<br/> worth of equity investments.</p>
          <h2 className="fs-4">No spam or gimmicks</h2>
          <p className="text-muted">No gimmicks, spam, "gamification", or annoying push notifications. High<br/> quality apps that you use at your pace, the way you like.</p>
        ...
        <div className='col-6 text-center pt-5'>
          <img src="media/images/ecosystem.png" style={{width:"75%"}}/><br/>
